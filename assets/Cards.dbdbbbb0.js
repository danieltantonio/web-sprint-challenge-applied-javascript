...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/Cards.js":[function(require,module,exports) {
...
function Cards(articleObjData) {
  ...
  authorImg.src = './assets/sir.jpg';
  authorName.textContent = "By ".concat(articleObjData.authorName);
...
axios.get('https://lambda-times-backend.herokuapp.com/articles').then(function (res) {
  ...
  Object.keys(res.data.articles).forEach(function (articleType) {
    res.data.articles[articleType].forEach(function (article) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7709" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/Cards.js"], null)
//# sourceMappingURL=/Cards.dbdbbbb0.js.map